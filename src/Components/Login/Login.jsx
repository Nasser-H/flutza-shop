      ...
      <section className="py-10 px-12">
        <div className="text-white text-lg  mb-4 flex justify-center">
          <div className="bg-red-500 w-fit py-1 px-6 flex">
           <div className="me-1 mt-2 rounded-full size-4 border bg-white flex justify-center items-center"><i className="fa-solid fa-exclamation text-sm text-main"></i></div>WARNING : console.error();</div>
        </div>        
        ...
        <form className="max-w-md mx-auto pt-10">
          <div className="relative z-0 w-full mb-5 group">
            ...
            <div className="text-red-500 text-sm mt-2 ms-2">console.error();</div>
          </div>
